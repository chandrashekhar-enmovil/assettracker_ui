...
//       const isSkillSelected = prevSelectedSkills[categoryName].includes(skill);
//       const updatedSkills = isSkillSelected
//         ? prevSelectedSkills[categoryName].filter((s) => s !== skill)
//         : [...prevSelectedSkills[categoryName], skill];
//       return {
//         ...prevSelectedSkills,
