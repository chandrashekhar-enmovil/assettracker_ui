...
const Experience = () => {
  ...
  const handleAddFields = () => {
    updateFormData('experience', [
      ...formData.experience,
      { companyName: '', designation: '', department: '', tenure: '', supervisorName: '', supervisorInfo: '',experienceFile:'' },
    ]);
          ...
          <>
            {formData.experience.map((exp, idx) => (
              ...
              <input
                accept="image/*"
                style={{ display: 'none' }}
                id="upload-experienceFile"
                type="file"
                onChange={(e) => handleUpdateExperience(idx, 'experienceFile', e.target.files[0] || '')}
              />
              <label htmlFor="upload-experienceFile" style={styles.uploadLabel}>
                <Button
                  variant="outlined"
                  component="span"
                  fullWidth
              ...
              {formData.experience.experienceFile &&<Text>{formData.experience.experienceFile[idx].name}</Text>}
            </View>
